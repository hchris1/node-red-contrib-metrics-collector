...
class PrometheusExporter {
    ...
    setupRoutes() {
        ...
        // Add catch-all route for better error handling (Express 5.x compatible)
     ...
     * @param {string} metricsRoute - Metrics endpoint route
     * @param {string} jsonRoute - JSON metrics endpoint route
     * @param {string} healthRoute - Health check endpoint route
     */
    start(host = 'localhost', port = 1881, metricsRoute = '/metrics', jsonRoute = '/metrics/json', healthRoute = '/health') {
        return new Promise((resolve, reject) => {
            ...
            try {
                ...
                // Performance: Set server timeout
